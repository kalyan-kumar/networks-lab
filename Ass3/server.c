...
int main()
{
    ...
    //srv_addr.sin_addr.s_addr = inet_addr ("1.2.3.4");						// What is this??
    ...
    iph->daddr = cli_addr.sin_addr.s_addr;
    ...
    //{
        //Send the packet
        if (sendto (sfd, datagram, iph->tot_len ,  0, (struct sockaddr *) &cli_addr, sizeof (cli_addr)) < 0)
